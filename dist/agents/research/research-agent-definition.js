 ...
 */
import { DEFAULT_AGENT_LIMITS, DEFAULT_TOOL_LIMITS, ENVIRONMENTS, } from "../../contracts/index.js";
 ...
 */
export const researchSearchToolDefinition = {
...
export const researchFetchToolDefinition = {
...
export const RESEARCH_AGENT_LIMITS = {
 ...
 */
export function researchAgentGrants(agentId = RESEARCH_AGENT_ID, extra = []) {
    return [
        {
            effect: "allow",
            action: "execute",
...
export function makeResearchAgentDefinition(options) {
    return {
        id: RESEARCH_AGENT_ID,
        name: "Research Agent",
        description: "Reusable general agent that runs a bounded, source-grounded research " +
        ...
        permissions: researchAgentGrants(RESEARCH_AGENT_ID, options.extraGrants ?? []),
        ...
        metadata: {
            ...
            errorBehavior: "fail closed with a structured AgentExecutionError (reason + details); " +
...
export const researchApprovalPolicy = {
    evaluate: (task) => {
        ...
        return {
            ...
            reason: "research task requests a state-changing or outbound capability and " +

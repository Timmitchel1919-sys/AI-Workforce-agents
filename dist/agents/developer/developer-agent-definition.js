...
export const DEVELOPER_AGENT_LIMITS = {
 ...
 */
export function developerGrants(agentId = DEVELOPER_AGENT_ID, extra = []) {
    return [
        ...extra,
...
export function makeDeveloperAgentDefinition(options) {
    return {
        id: DEVELOPER_AGENT_ID,
        name: "Developer Agent",
        description: "Produces an implementation plan and a set of proposed, described code " +
        ...
        metadata: {
            ...
            errorBehavior: "fail closed with a structured AgentExecutionError; never apply a " +

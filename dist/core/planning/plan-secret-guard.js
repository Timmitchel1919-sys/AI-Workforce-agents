...
const SECRET_VALUE = /(sk-[A-Za-z0-9_-]{12,}|ghp_[A-Za-z0-9]{16,}|github_pat_[A-Za-z0-9_]{20,}|xox[baprs]-[A-Za-z0-9-]{10,}|AKIA[0-9A-Z]{12,}|AIza[0-9A-Za-z_-]{30,}|-----BEGIN [A-Z ]*PRIVATE KEY-----|eyJ[A-Za-z0-9_-]{10,}\.[A-Za-z0-9_-]{10,}\.)/;
const SECRET_KEY = /^(api[_-]?key|apikey|password|passwd|private[_-]?key|client[_-]?secret|access[_-]?token|refresh[_-]?token|id[_-]?token|secret[_-]?value|token)$/i;

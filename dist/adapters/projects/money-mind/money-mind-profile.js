 ...
 */
import { MONEY_MIND_PROJECT_ID, } from "../../../contracts/index.js";
/**
 ...
 */
export const MONEY_MIND_PROFILE = {
...
export function agentsForMoneyMindCapability(capability) {
 ...
 */
export const MONEY_MIND_CAPABILITY_ACTIONS = {
    READ_PROJECT: "read",
    READ_STATUS: "read",
 ...
 * here.
 */
export function moneyMindGrants(agentId) {
    const capabilities = MONEY_MIND_PROFILE.allowedCapabilitiesByAgent[agentId] ?? [];
    const actions = new Set(capabilities.map((capability) => MONEY_MIND_CAPABILITY_ACTIONS[capability]));
    const grants = [];
...
export function allMoneyMindGrants() {
    return Object.keys(MONEY_MIND_PROFILE.allowedCapabilitiesByAgent).flatMap(moneyMindGrants);
}

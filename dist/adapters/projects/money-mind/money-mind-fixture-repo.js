...
export function defaultMoneyMindFixtureFiles() {
    return {
        "README.md": [
            "# Fixture Finance App",
            "",
...
export class InMemoryMoneyMindRepo {
    files;
    scripts;
    scriptResults;
    ...
    async readTextFile(relPath) {
        ...
        if (content === undefined) {
            throw new NotFoundError(`file not found in money-mind fixture: ${relPath}`);
        }
        return content;
    }
    ...
    async runScript(script, _timeoutMs) {

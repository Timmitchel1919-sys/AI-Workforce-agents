 ...
 */
export const AI_WORKFORCE_REPOSITORY: ProjectRepositoryRef = Object.freeze({
...
export class AiWorkforceProjectAdapter extends BaseProjectAdapter {
  readonly projectId = AI_WORKFORCE_PROJECT_ID;
  protected readonly displayName = AI_WORKFORCE_DISPLAY_NAME;
  protected readonly operations: Record<string, ProjectOperation> = {
    READ_PROJECT: {
      capability: {
        operation: "READ_PROJECT",
        description:
          "Read the AI Workforce project's identity and repository reference.",
        action: "read",
      },
      handler: () => ({
        ...
        description:
          "The AI Workforce platform: the Control Plane, agents, orchestration and UI in this repository.",
